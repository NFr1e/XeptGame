...
{
    /// <summary>
    /// UIRoundedCorners 的自定义 Inspector。支持统一/独立半径 + 抗锯齿强度。
    /// </summary>
    [CustomEditor(typeof(UIRoundedCorners))]
    [CanEditMultipleObjects]
    public class UIRoundedCornersEditor : UnityEditor.Editor
    {
        ...
        private void DrawUniformRadius()
        {
            ...
            var corners = target as UIRoundedCorners;
