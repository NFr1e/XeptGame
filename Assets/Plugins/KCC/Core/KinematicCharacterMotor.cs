...
#pragma warning restore 0414 
        ...
        private bool CharacterGroundSweep(Vector3 position, Quaternion rotation, Vector3 direction, float distance, out RaycastHit closestHit)
        {
            ...
            int nbUnfilteredHits = Physics.CapsuleCastNonAlloc(
                ...
                // [XeptGame 修改] 原: CollidableLayers & StableGroundLayers
                // 接地探测改为全部碰撞层：非 StableGroundLayers 的对象也应正常探测/吸附/提供法线，
                // "可站立 vs 不可站立"的互斥判定由业务层基于 StableGroundLayers 完成
                // （见 docs/modules/3C_CharacterMotor_Design.md §5.4）。升级 KCC 时注意此修改点。
                CollidableLayers,
                QueryTriggerInteraction.Ignore);
