...
{
    /// <summary>
    /// 身体槽位标识（一等值，Equip_FPV_Design.md §2.2/§3.2；Item_Instance_Design.md §3 追加背槽）——
    /// 现有成员：手部槽、背部槽；甲/腿 ⏳ 追加成员 = 扩展（纯新增，消费方合同零改动）。
    ...
    public enum BodySlotType
    {
        ...
        /// <summary>背部槽：单位制，只接纳容器类物品（<c>ContainerFacet</c>）；其内容即"当前背包"。</summary>
        Back = 1,
    }
}
