...
namespace XeptGame.Container
{
    ...
    /// <list type="bullet">
    /// <item><b>种类门控恒真</b>：任何物品都能进格（"参与背包系统"由 <see cref="InventoryItemFacet"/> 另行表达分类与上限）；</item>
    /// <item><b>数目门控 = 物品声明的每格上限</b>：读 <c>InventoryItemFacet.profile.ResolvedMaxStack</c>；
    ...
    public sealed class StackSlot : SlotBase
    {
        ...
        public override int CapacityFor(ItemDefinition definition)
        {
            ...
            var facet = definition.GetFacet<InventoryItemFacet>();
